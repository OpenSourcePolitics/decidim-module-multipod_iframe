...
require "decidim/multipod_iframe/version"

Gem::Specification.new do |s|
  s.version = Decidim::MultipodIframe.version
  ...
  s.name = "decidim-multipod_iframe"
  s.summary = "A decidim multipod_iframe module"
  s.description = "iframe for multipod."
